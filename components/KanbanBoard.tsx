    ...
    <div className="px-6 py-3 border-b border-border bg-muted/30">
      <div className="flex flex-wrap items-center gap-4 text-xs">
        ...
        <div className="flex items-center gap-1">
          <span className="w-3 h-3 rounded bg-score-excellent border border-border" />
          <span className="text-muted-foreground">80+ Excellent</span>
        </div>

        <div className="flex items-center gap-1">
          <span className="w-3 h-3 rounded bg-score-good border border-border" />
          <span className="text-muted-foreground">70–79 Good</span>
        </div>

        <div className="flex items-center gap-1">
          <span className="w-3 h-3 rounded bg-score-fair border border-border" />
          <span className="text-muted-foreground">60–69 Fair</span>
        </div>

        <div className="flex items-center gap-1">
          <span className="w-3 h-3 rounded bg-score-poor border border-border" />
